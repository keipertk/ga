...
/*
#ifdef USE_DEVICE_MEM
     if(llist_empty(_ga_active_data_block))
      printf("PNGA_DESTROY() -- List Empty!\n");
     else {
      printf("Printing List Before Destroy Called.\n");
      llist_print(_ga_active_data_block);
      printf("PNGA_DESTROY() -- List Not Empty! List Count: %d\n", llist_size(_ga_active_data_block));
     }
#endif
*/
...
#ifdef USE_DEVICE_MEM
    llist_remove_val(&_ga_active_data_block, ga_handle);
#endif
...
#ifdef USE_DEVICE_MEM
    if(llist_empty(_ga_active_data_block))
      printf("PNGA_TERMINATE() -- List Empty!\n");
    else
      printf("PNGA_TERMINATE() -- List Not Empty! List Count: %d\n", llist_size(_ga_active_data_block));
#endif
*/
...
#ifdef USE_DEVICE_MEM
    if(llist_empty(_ga_active_data_block))
      printf("PNGA_TERMINATE() --2-- List Empty!\n");
    else
      printf("PNGA_TERMINATE() --2-- List Not Empty! List Count: %d\n", llist_size(_ga_active_data_block));
#endif
*/
}
